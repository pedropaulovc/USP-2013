...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Um Algoritmo de Escalonamento em Computação em Nuvem 
    ...
    Co-orientadora: Elaine Naomi Watanabe
...
%\chapter*{Resumo}
%
%\noindent CAMPOS, P P. V. \textbf{Título do trabalho em português}. 
%2010. 120 f.
