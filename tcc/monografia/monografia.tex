...
2013. 32 p. %TODO Editar na versão final
...
quantidades de dados (\emph{Big data}) gerando resultados relevantes a um custo
aceitável.

Um dos maiores custos envolvidos na operação de uma nuvem é a energia
necessária para manter o parque de servidores operando e refrigerado. Para 
...
trabalho realísticas para gerar experimentos que avaliem a corretude e
eficiência do algoritmo proposto. \\

\noindent \textbf{Palavras-chave:} computação em nuvem, escalonamento, consumo
energético, CloudSim, WorkflowSim.

% ---------------------------------------------------------------------------- %
% Abstract
\chapter*{Abstract}

\noindent CAMPOS, P P. V. \textbf{A Scheduling Algorithm for the Reduction
of Energy Consumption in Cloud Computing}.
2013. 32 p. %TODO Editar na versão final
...
to cloud computing providers, capable of processing large amounts of data 
(Big data) generating useful results at a reasonable price.

One of the greatest costs involved in the operation of a cloud is the energy
necessary to keep the servers pool operating and refrigerated. To reduce
such costs this senior project presents a scheduling algorithm for cloud
computing that reduces such enegy consumption.

A cloud computing simulator was used together with realistc workloads to
generate experiments that verify the correctness and efficiency of the proposed
algorithm.\\

\noindent \textbf{Keywords:} cloud computing, scheduling, energy
consumption, CloudSim, WorkflowSim.
...
\begin{minipage}{3.5cm}{
	...
	\hfill{}{Kraftwerk}
%	\vspace{-1em}
%	\begin{flushright}{Computer Love -- Computer World}
%	\end{flushright}
}
\vspace{2em}
\end{minipage}
