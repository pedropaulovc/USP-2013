...
Computação em nuvem é uma expressão utilizada para definir o conceito de uso de
serviços de computação como um serviço. Apesar do termo ainda não possuir uma
...
com $B_n$ sendo o número o número de partições de um conjunto de tamanho $n$.
