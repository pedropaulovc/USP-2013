...
Computação em Nuvem}
\author{\hskip 10.9cm Pedro Paulo Vezzá Campos \hskip 1cm \url{pedrovc@ime.usp.br} \and \\ \vskip0.2cm  Orientador: Prof. Dr. Daniel Macêdo Batista \hskip 1cm \url{batista@ime.usp.br}}
...
\begin{column}{0.35\paperwidth}% the right size for a 3-column layout
	...
	\begin{alertblock}{Introdução}
		...
		para otimizar o uso de algum recurso é \colorize{n_red}{NP-difícil}.
		Logo, heurísticas são usadas para encontrar soluções aproximadas.
	\end{alertblock}
	...
	\begin{alertblock}{Resultados}
		...
		e com o algoritmo \emph{Heterogeneous Earliest Finish Time}. Os estudos contaram com a
		contribuição da aluna de mestrado \colorize{RawSienna}{Elaine Naomi Watanabe}
		(\url{elainew@ime.usp.br}).

		\vskip2ex

		Ainda, foram feitas \colorize{olive}{contribuições}
		...
		nuvem utilizados pelo autor. O \colorize{n_blue}{código fonte} produzido
		para o TCC está disponível em: \texttt{http://migre.me/gAlQn}
	\end{alertblock}
