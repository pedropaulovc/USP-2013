...
\addplot[rendering,fill=rendering] coordinates { (1,3) (2,5) (3,7) (4,8) };
\addplot[transfertoclient,fill=transfertoclient] coordinates { (1,2) (2,2) (3,1) (4,1) };
\addplot[transfertoserver,fill=transfertoserver] coordinates { (1,3) (2,1) (3,1) (4,1) };
\legend{Transfer,Database,Transfer}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}\pgfplotsset{compat=1.8}
