 ...
 * @date Apr 9, 2013
 */
public class NonPowerAwareDatacenterExtended extends PowerDatacenterNonPowerAware {

    public NonPowerAwareDatacenterExtended(String name,
    ...
    private void updatePowerProcessing() {
