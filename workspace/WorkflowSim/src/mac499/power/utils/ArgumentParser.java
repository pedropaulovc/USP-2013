...
import mac499.power.utils.ClusteringParameters.ClusteringMethod;
import mac499.power.utils.Parameters.FTCFailure;
import mac499.power.utils.Parameters.FTCMethod;
import mac499.power.utils.Parameters.FTCMonitor;
import mac499.power.utils.Parameters.PLNMethod;
...
public class ArgumentParser {
    ...
    public ArgumentParser(String[] args) {
        ...
        try {
            ...
            if(pln_method.equals(PLNMethod.HEFT) ^ sch_method.equals(SCHMethod.HEFT_SCH)){
            	/**
                 * Let's guarantee that both parts of the HEFT algorithm will work together.
                 */
            	Log.printLine("Warning: The HEFT algorithm requires that " +
            			"planner.method == HEFT and scheduler.method == HEFT_SCH.");
            	Log.printLine("Warning: planner.method is reset to be RANDOM");
            	Log.printLine("Warning: scheduler.method is reset to be STATIC_SCH");
            	pln_method = PLNMethod.RANDOM;
            	sch_method = SCHMethod.STATIC_SCH;
            } else if(!pln_method.equals(PLNMethod.INVALID) && !pln_method.equals(PLNMethod.HEFT)){
            	/**
                 ...
                 * except if we are using the HEFT algorithm.
                 */
